...
io500_mpirun="mpirun"
io500_mpiargs="--pmi=pmix --no-vni -np 2080 -ppn 208 -genv DAOS_POOL=mypool -genv DAOS_CONT=mycont -hostfile /scratchbox/daos/mschaara/io500/run_scripts/clients10"
