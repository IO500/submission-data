...
io500_mpirun="mpirun"
io500_mpiargs="-np 160 -N 16 --hostfile hosts -x LD_LIBRARY_PATH -x MXM_RDMA_PORTS=mlx5_2 --bind-to cpulist:ordered --cpu-list '0,7,15,23,31,39,47,55,63,71,79,87,95,103,111,119'"
