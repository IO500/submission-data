...
# Most of the variables set in here are needed for io501_fixed.sh which gets sourced at the end of this.
# Please also edit 'extra_description' function.

source /opt/cluster/tools/openmpi/env-3.1.4.sh
...
function setup_ior_easy {
  ...
  io500_ior_easy_params="-t 1024k -b ${io500_ior_easy_size}g -F"
}
...
function extra_description {
  # top level info
  io500_info_system_name='HPC5G'      # e.g. Oakforest-PACS
  io500_info_institute_name='CNES'   # e.g. JCAHPC
  io500_info_storage_age_in_months='1' # not install date but age since last refresh
  io500_info_storage_install_date='03/16'  # MM/YY
  ...
  io500_info_storage_interface='SAS, NVMe' # SAS, SATA, NVMe, etc
  # miscellaneous
