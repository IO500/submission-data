...
function setup_paths {
  ...
  io500_mpiargs="-np $NP --mca btl_tcp_if_exclude ib0 --mca btl ^openib --map-by node --machinefile /home/jburto2/tennodelistmpi --prefix $io500_mpi_prefix"
}

function setup_ior_easy {
# 2M writes, 144 GB per proc, file per proc. 
  io500_ior_easy_size=$((144 * 1024 / $SCALE))
...
function extra_description {
  ...
  # client side info
  io500_info_num_client_nodes="$(( ${SCALE} * 10 ))"
