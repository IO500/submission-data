...
io500_mpirun="mpirun"
#io500_mpiargs="--bind-to core:overload-allowed --allow-run-as-root ./singularity.sh /exafs -B /work -B /usr -B /sys/class/infiniband_verbs -B /bin -B /sbin -B /etc/libibverbs.d centos8.sif "
...
function setup(){
  ...
  lfs setstripe -C 640 $workdir/ior-hard
