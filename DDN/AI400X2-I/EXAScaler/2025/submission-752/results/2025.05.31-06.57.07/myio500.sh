...
io500_mpirun="mpirun"
io500_mpiargs="--oversubscribe --bind-to core:overload-allowed -x UCX_NET_DEVICES=mlx5_0:1 singularity.sh /exafs 8 -B /usr -B /work /work/BMLab/Lustre/io500/io500.git/rockylinux_9.sif"
...
function setup(){
  ...
  lfs setdirstripe -D -C 16 $workdir/mdtest-hard
