...
#io500_mpiargs="--bind-to core:overload-allowed --allow-run-as-root singularity.sh -B /work -B /usr -B /sys/class/infiniband_verbs -B /bin -B /sbin -B /etc/libibverbs.d ubuntu22.04.sif "
