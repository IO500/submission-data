...
function setup_directories {
  ...
  io500_workdir=/bfs/datafiles/io500.$timestamp # directory where the data will be stored
...
#  io500_mpirun="/usr/mpi/gcc/openmpi-4.0.2a1/bin/mpirun"
  io500_mpirun="/opt/ddn/mvapich/bin/mpirun"
#  io500_mpiargs="-np 30 -v --map-by node --allow-run-as-root -machinefile 10-ime-nodes.lst"
...
#  io500_mpiargs="-n 40 -ppn 4 -v -machinefile 10-ime-nodes.lst -genv MV2_NUM_HCAS 1 "
}
...
#  io500_ior_easy_params="-a IME -H -t 256k -b ${io500_ior_easy_size}m -F"
  io500_ior_easy_params="-a IME -H -t 256k -b 256k -s 3600000 "
#  io500_ior_easy_params="-a IME -H -t 256k -b 256k -s 1000 "

}

function setup_mdt_easy {
  io500_mdtest_easy_params="-a IME -H -u " # unique dir per thread, files only at leaves
  io500_mdtest_easy_files_per_proc=500000
}

function setup_ior_hard {
  io500_ior_hard_writes_per_proc=4150000
  io500_ior_hard_other_options="-a IME -H " #e.g., -E to keep precreated files using lfs setstripe, or -a MPIIO or -U=hintsfile
}
