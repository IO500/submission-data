...
io500_mpiargs=" -np 420 --map-by node --prefix /usr/local/openmpi  --hostfile /home/io500/io500/mpihostfile --allow-run-as-root  -x LD_PRELOAD=/home/io500/HPFS/app/lib/libhpfs_intercept.so -x LD_LIBRARY_PATH=:/home/io500/HPFS/hpdeps/install/lib:/home/io500/HPFS/hpdeps/install/lib64:/usr/local/openmpi/bin -x LIBHPFS_HOSTS_FILE=/home/io500/HPFS/hpfs_hosts.txt "
...
function setup(){
  ...
  LIBHPFS_HOSTS_FILE=/home/io500/HPFS/hpfs_hosts.txt LD_PRELOAD=/home/io500/HPFS/app/lib/libhpfs_intercept.so mkdir -p $io500_workdir-{scr,app}/{ior_easy,ior_hard,mdtest_easy,mdtest_hard} $io500_resultdir-{scr,app}
