...
io500_mpirun="mpirun"
#io500_mpiargs=""
io500_mpiargs="--bind-to core:overload-allowed ./singularity.sh /lustre/gefion1 -B /cm -B /opt -B /home1 -B /usr -B /bin -B /sbin -B /sys/class/infiniband_verbs rockylinux_9.sif"
...
function setup(){
  ...
  ssh root@172.29.48.1 "lfs setstripe -C 320 /lustre/gefion1/client/ddn/io500/datafiles/io500/ior-hard"
