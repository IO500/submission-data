...
#SBATCH --nodes=128
##SBATCH --nodelist=dgx010,dgx011,dgx032,dgx033,dgx070,dgx071,dgx102,dgx101,dgx132,dgx133
##SBATCH --nodelist=dgx[040-049]
#SBATCH --exclusive
...
/home1/fbrunkhorst/io500-new/io500/io500-ddn.sh config-ddn-large.ini
