...
#io500_mpirun="mpirun --bind-to core:overload-allowed"
io500_mpirun="mpirun"
io500_mpiargs="--bind-to core:overload-allowed --map-by core"
#io500_mpiargs="--bind-to core:overload-allowed --map-by core ./singularity.sh /lustre/gefion1 -B /cm -B /opt -B /home1 -B /usr -B /bin -B /sbin -B /sys/class/infiniband_verbs rockylinux_9.sif"
...
function setup(){
  ...
  mkdir /lustre/gefion1/ddn/io500/datafiles/io500/mdtest-easy -p
  mkdir /lustre/gefion1/ddn/io500/datafiles/io500/mdtest-hard -p
  #mkdir /lustre/gefion1/ddn/io500/datafiles/io500/ior-easy -p
  mkdir /lustre/gefion1/ddn/io500/datafiles/io500/ior-hard -p

  ssh root@172.29.48.1 "lfs setstripe -C 960 /lustre/gefion1/client/ddn/io500/datafiles/io500/ior-hard"
  ssh root@172.29.48.1 "lfs setdirstripe -D -c -1 /lustre/gefion1/client/ddn/io500/datafiles/io500/mdtest-hard"
  ssh root@172.29.48.1 "lfs setdirstripe -D --max-inherit-rr 2 /lustre/gefion1/client/ddn/io500/datafiles/io500/mdtest-easy"

  #/usr/bin/python ./pin.py -s 0 -e 95 -t 640 -n 10 -o /lustre/gefion1/ddn/io500/datafiles/io500/ior-easy/ior_file_easy

# usage: pin.py [-h] -s START -e END -t THREADS -n NODES -o OUTPUT
# pin.py: error: the following arguments are required: -s/--start, -e/--end, -t/--threads, -n/--nodes, -o/--output
