...
function setup(){
  ...
  ssh root@10.128.84.1 "lfs setdirstripe -D -c 1 -i -1 --max-inherit -1 --max-inherit-rr -1 $workdir/mdtest-easy"
  ssh root@10.128.84.1 "lfs setdirstripe -D -c 8 $workdir/mdtest-hard"
  ssh root@10.128.84.1 "lfs setstripe -E 1m -L mdt $workdir/mdtest-easy"
  ssh root@10.128.84.1 "lfs setstripe -E 1m -L mdt $workdir/mdtest-hard"
}
