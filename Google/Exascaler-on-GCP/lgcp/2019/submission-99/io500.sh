...
function setup_directories {
  ...
  io500_workdir=/lustre/lgcpfs/client/io500/datafiles/io500.$timestamp # directory where the data will be stored
  io500_result_dir=/lustre/lgcpfs/client/io500/results/$timestamp      # the directory where the output results will be kept
  mkdir -p $io500_workdir $io500_result_dir
  lfs setdirstripe -c 20 $io500_workdir/mdt_easy
  lfs setdirstripe -c 20 $io500_workdir/mdt_hard
  lfs setdirstripe -c 20 -D $io500_workdir/mdt_easy
  lfs setdirstripe -c 20 -D $io500_workdir/mdt_hard
...
function setup_mdt_easy {
  ...
  io500_mdtest_easy_files_per_proc=335000
}
...
function extra_description {
  # top level info
  io500_info_system_name='Google Cloud Platform'      # e.g. Oakforest-PACS
  io500_info_institute_name='Google and DDN'   # e.g. JCAHPC
