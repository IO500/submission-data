...
io500_mpirun="/usr/lib64/mpich/bin/mpiexec"
io500_mpiargs="--ppn 20 -hostfile host.list"
...
function run_benchmarks {
	echo "$io500_mpirun $io500_mpiargs $PWD/io500 $io500_ini --timestamp $timestamp"
