...
io500_mpirun="/nshare/pidsouza/mpich/install/bin/mpiexec"
...
host_name=$2
procs=$3
#io500_mpiargs="-f /nshare/pidsouza/io500/monthly/io500_sc23/nodesib -n 200"
io500_mpiargs="-f ${host_name} -n ${procs}"
