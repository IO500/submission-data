...
#io500_mpirun="/home/mpich/bin/mpiexec"
io500_mpirun="mpiexec"
#io500_mpiargs="-f ${host_name} -n ${procs} -ppn 30"
#orig
#io500_mpiargs="-f ${host_name} -ppn 20"
#client first socket only
io500_mpiargs="--bind-to numa:1 -f ${host_name} -genv I_MPI_PIN_DOMAIN=core -ppn $procs"

#io500_mpirun="/nshare/pidsouza/mpich-4.1/install/bin/mpiexec"
#io500_mpiargs="-f /nshare/pidsouza/io500/monthly/ISC2023_04212023/nodesib.9 -n 180"
#io500_mpiargs="-f /nshare/ess_regression/ess6000/io500/nodesib.10 -n 200 -ppn 20"
#io500_mpiargs="-f -n ${procs} -ppn 20"
