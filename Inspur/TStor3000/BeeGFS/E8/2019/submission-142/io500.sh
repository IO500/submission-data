...
function setup_directories {
  ...
  io500_workdir=/mnt/beegfs/io500_datafiles/io500.$timestamp # directory where the data will be stored
  io500_result_dir=/mnt/beegfs/results/$timestamp      # the directory where the output results will be kept
...
function setup_ior_easy {
  ...
  io500_ior_easy_params="-t 2048k -b ${io500_ior_easy_size}m  -a MPIIO -B -F"
}
...
function setup_ior_hard {
  ...
  io500_ior_hard_other_options="-B -a MPIIO" #e.g., -E to keep precreated files using lfs setstripe, or -a MPIIO
}
...
function extra_description {
  # top level info
  io500_info_system_name='Tstor3000'      # e.g. Oakforest-PACS
  io500_info_institute_name='inspur'   # e.g. JCAHPC
  io500_info_storage_age_in_months='1' # not install date but age since last refresh
  io500_info_storage_install_date='5/2019'  # MM/YY
  ...
  io500_info_num_data_storage_devices='31'  # if you have 5 data servers, and each has 5 drives, then this number is 25
