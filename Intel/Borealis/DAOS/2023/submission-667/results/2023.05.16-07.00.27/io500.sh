...
########################################################################
#
# Intel "Borealis" Slurm script for DAOS benchmarks on the IB fabric
#
########################################################################
#
#export PATH="${HOME}/mpich-4.1.1-nemesis/bin:$PATH"
#export CPATH="${HOME}/mpich-4.1.1-nemesis/include:$CPATH"
#export LD_LIBRARY_PATH="${HOME}/mpich-4.1.1-nemesis/lib:$LD_LIBRARY_PATH"
#
