...
#SBATCH          --output=log.io500_dfs.daos.10-112.300sec.%J
#SBATCH           --error=log.io500_dfs.daos.10-112.300sec.%J
...
export DAOS_HOSTLIST="daos21"
export DAOS_POOL="${USER}_pool01"
export DAOS_CONT="${USER}_cont01"
...
echo `date`
echo
echo "Intel Florence Slurm Job configuration:"
echo "* Jobid : $SLURM_JOB_ID"
echo "* Hosts : $SLURM_JOB_NODELIST"
echo "* Nodes : $SLURM_NNODES"
echo "* Ranks : $SLURM_NTASKS"
echo
echo "Intel Florence DAOS configuration (daos):"
...
echo
echo "Intel Florence MPI configuration:"
echo
mpichversion
...
#io500_mpiargs="-np 2"
io500_mpirun="mpirun --bind-to $MPI_BIND_TO -genvall -genv DAOS_POOL $DAOS_POOL -genv DAOS_CONT $DAOS_CONT "
io500_mpiargs=""
