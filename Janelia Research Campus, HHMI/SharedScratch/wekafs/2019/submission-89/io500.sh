...
function setup_paths {
  ...
  io500_mpirun="mpirun"
  io500_mpiargs="--nolocal -np 1368 -ppn 76 -f ./site-configs/hhmi/hostfile-18gpu --bootstrap ssh"
}
...
function extra_description {
  ...
  echo io500_info_filesystem_version='"3.5.2"'
  echo io500_info_client_nodes='"18"'
  ...
  echo io500_info_ds_storage_devices='"80"'
  ...
  echo io500_info_ds_software_version='"3.5.2"'
