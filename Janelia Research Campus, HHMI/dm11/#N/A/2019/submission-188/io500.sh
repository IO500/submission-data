...
function extra_description {
  ...
  echo io500_info_system='"dm11"'
  echo io500_info_system_classification='"production"'
  echo io500_info_storage_install_date='"3/2018"'
  echo io500_info_filesystem_type='"Scale-out NAS"'
  echo io500_info_filesystem_version='"8.1.2"'
  ...
  echo io500_info_md_nodes='"12"'
  echo io500_info_md_storage_devices='"15"'
  echo io500_info_md_storage_type='"SAS-SSD"'
  echo io500_info_md_storage_interface='"SAS"'
  echo io500_info_md_network='"40gigE"'
  echo io500_info_md_software_version='"8.1.2"'
  echo io500_info_md_overhead='"17"'
  echo io500_info_ds_nodes='"56"'
  echo io500_info_ds_storage_devices='"15"'
  echo io500_info_ds_storage_type='"HDD"'
  echo io500_info_ds_storage_interface='"SATA"'
  echo io500_info_ds_network='"Ethernet"'
  echo io500_info_ds_overhead='"16"'
  echo io500_info_whatever='"2 different node types. All SSD nodes are used as ingest pool (listed as metadata server). Data is destaged to hybrid pool (listed as data server) on a schedule based on mtime and file size. For the purposes of this test, all data resides on the all flash tier. "'
}
