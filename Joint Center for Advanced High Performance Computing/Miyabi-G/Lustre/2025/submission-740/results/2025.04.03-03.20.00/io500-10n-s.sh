...
io500_mpirun="mpirun"
#io500_mpiargs="./singularity.sh /work -B /work -B /usr -B /sys/class/infiniband_verbs -B /bin -B /sbin -B /etc/libibverbs.d rockylinux9.aarch64.sif"
io500_mpiargs="./singularity.sh /work -B /home -B /lib64 /home/z30232/io500/rockylinux9.aarch64.sif"
...
function setup(){
  ...
  lfs setstripe -C 800 $workdir/ior-hard
