...
#SBATCH          --output=log.io500_dfs_rf1.ucx_dcx.192-112.300sec.%J
#SBATCH           --error=log.io500_dfs_rf1.ucx_dcx.192-112.300sec.%J
...
export DAOS_CONT="cont_rf0_e256kiB"
...
#io500_mpirun="mpirun -n 21504 $MPI_BIND_TO -genvall -genv D_POOL_WARMUP 1 -genv DAOS_POOL $DAOS_POOL -genv DAOS_CONT $DAOS_CONT -genv DAOS_PREFIX $DAOS_MOUNT"
...
function setup(){
  ...
  io500_mpirun="mpirun -n 21504 $MPI_BIND_TO -genvall -genv D_POOL_WARMUP 1 -genv DAOS_POOL $DAOS_POOL -genv DAOS_CONT $DAOS_CONT -genv DAOS_PREFIX $workdir"
...
cat ${io500_ini}.tmp | sed "s/@STONEWALL/300/g; s/@NPROC/$SLURM_NTASKS/g; s/@DAOS_POOL/$DAOS_POOL/g; s/@DAOS_CONT/$DAOS_CONT/g; s#/tmp/di49puz3_pool01/cont_rf0_e256kiB#$DAOS_MOUNT#g" > ${io500_ini}
rm ${io500_ini}.tmp
