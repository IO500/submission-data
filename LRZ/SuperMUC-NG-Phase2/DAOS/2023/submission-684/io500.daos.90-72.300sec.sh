...
#SBATCH          --output=log.io500_dfs.daos.90-72.300sec.%J
#SBATCH           --error=log.io500_dfs.daos.90-72.300sec.%J
...
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01" ; export MACHINE="machinefile.i20r02compute"
export DAOS_POOL="lrz_m02r01r02" ; export DAOS_CONT="cont01" ; export MACHINE="machinefile.i20r01r02compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r02r03r04r05compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20.2023-09-20.2232"
export DAOS_POOL="lrz_18srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r01compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r01compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r03r04r05r06compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r08compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r03r04r05r06r07r08compute"
export DAOS_POOL="lrz_42srv" ; export DAOS_CONT="cont01_rf0" ; export MACHINE="machinefile.i20r04r05r06r07compute"
...
export SLURM_JOB_NODELIST=`cat $MACH|cut -d: -f1|while read H; do echo -n "${H},"; done|sed "s/,$//"`
...
io500_mpirun="mpirun -f $MACH -n 6480 --bind-to $MPI_BIND_TO -genvall -genv DAOS_POOL $DAOS_POOL -genv DAOS_CONT $DAOS_CONT "
...
cat ${io500_ini}.tmp | sed "s/@STONEWALL/300/g; s/@NPROC/$SLURM_NTASKS/g; s/@DAOS_POOL/$DAOS_POOL/g; s/@DAOS_CONT/$DAOS_CONT/g; s#/daos/daosperf#$DAOS_FUSE#g" > ${io500_ini}
rm ${io500_ini}.tmp
...
#       $io500_mpirun $io500_mpiargs $HOME/io500-leap154-isc23-mpich411/io500 $io500_ini $IO500_MODE --timestamp $timestamp
  echo "$io500_mpirun $io500_mpiargs $HOME/io500-leap154-isc23-mpich411.stat-patch/io500 $io500_ini $IO500_MODE --timestamp $timestamp"
        $io500_mpirun $io500_mpiargs $HOME/io500-leap154-isc23-mpich411.stat-patch/io500 $io500_ini $IO500_MODE --timestamp $timestamp
}
