...
io500_mpirun="/admin/software/openmpi/openmpi-4.1.5/bin/mpirun"
#io500_mpiargs="-x TMPDIR -map-by node --hostfile /home/vallerul/software/io500_prod/io500/hostfile -bind-to none -mca pml ob1 -mca tcp,sm,self,btl ^openib"
io500_mpiargs="-x TMPDIR -map-by node --hostfile /home/vallerul/software/io500_prod/io500/hostfile -bind-to none -mca pml ob1"
