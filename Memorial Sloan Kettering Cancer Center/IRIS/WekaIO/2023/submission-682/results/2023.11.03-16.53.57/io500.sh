...
io500_mpirun="/home/vallerul/software/openmpi/bin/mpirun"
io500_mpiargs="-x TMPDIR -np 4248 -map-by node --hostfile /home/vallerul/software/io500_sc23/io500/hostfile -bind-to none -mca pml ob1 -mca btl ^openib"
