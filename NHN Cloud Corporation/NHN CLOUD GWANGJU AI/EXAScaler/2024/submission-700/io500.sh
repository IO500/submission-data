...
io500_mpirun="/usr/mpi/gcc/openmpi-4.1.7a1/bin/mpiexec"
io500_mpiargs="-np 640 --hostfile /mnt/lustre/ddn/io500-main/10host-io500v4 --allow-run-as-root --mca orte_base_help_aggregate 0 --map-by node -x UCX_NET_DEVICES=mlx5_3:1,mlx5_5:1"
