...
function setup_paths {
  ...
  io500_mpirun="mpirun"
  io500_mpiargs="--allow-run-as-root -hostfile hosts -map-by ppr:6:socket -rank-by node -bind-to core -np 180 /g/data4/io500/io-500-dev/set-hca.sh"
}
...
function extra_description {
  ...
  # client side info
  io500_info_num_client_nodes='15'
