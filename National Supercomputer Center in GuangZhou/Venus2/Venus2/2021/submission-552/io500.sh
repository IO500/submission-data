...
io500_mpiargs="--hostfile hostfile -np 720"
...
function setup(){
  ...
  llfs-ctl --cfgFile=/etc/llfs/llfs-client.conf --setpattern --numtargets=240 --chunksize=4096k $workdir/ior-easy >> /etc/null
  llfs-ctl --cfgFile=/etc/llfs/llfs-client.conf --setpattern --numtargets=240 --chunksize=47008 $workdir/ior-hard >> /etc/null
}
