...
io500_mpiargs="-x LD_PRELOAD=${FS_BINARY}build/lib/libfs_syscall.so:${FS_BINARY}build/lib/libmalloc_intercept.so -H 10.1.101.120:120,10.1.100.195:120,10.1.100.184:120,10.1.101.66:120,10.1.101.90:120,10.1.101.8:120,10.1.100.186:120,10.1.100.193:120,10.1.101.121:120,10.1.100.216:120 -np 1200 --allow-run-as-root --use-hwthread-cpus --mca btl_tcp_if_include enp69s0"
