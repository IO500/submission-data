...
source /pw/test/linux/intel/Compiler/2022.1/mpi/latest/env/vars.sh

# This script takes its parameters from the same .ini file as io500 binary.
io500_ini="$1"          # You can set the ini file here
io500_mpirun="mpiexec"
#io500_mpiargs="-np 32"
#io500_mpiargs="-f hostlist.txt -n 100 -ppn 32"
#io500_mpiargs="-f hostlist.txt -n 100 -ppn 64"
#io500_mpiargs="-f hostlist.txt -n 100 -ppn 10"
#io500_mpiargs="-f hostlist.txt -n 160 -ppn 16"
#io500_mpiargs="-f hostlist.txt -n 320 -ppn 32"
#io500_mpiargs="-f hostlist.txt -n 640 -ppn 64"
io500_mpiargs="-f hostlist.txt -n 160 -ppn 16"
