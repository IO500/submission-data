...
function setup_paths {
  ...
  io500_mpirun="mpirun"
  io500_mpiargs="--prefix /usr/mpi/gcc/openmpi-4.0.4rc3 --allow-run-as-root --oversubscribe -n 360 -H 172.30.105.22,172.30.105.23,172.30.105.25,172.30.105.26,172.30.105.27,172.30.105.28,172.30.105.29,172.30.105.30,172.30.105.31,172.30.105.32 --mca pml ob1 --mca btl self,tcp --mca btl_tcp_if_include 172.30.105.0/21 --mca routed direct"
}
