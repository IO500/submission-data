...
function setup_paths {
  ...
  source /scratch/intel_mpi/compilers_and_libraries/linux/bin/compilervars.sh intel64
  source /scratch/intel_mpi/compilers_and_libraries/linux/mpi/intel64/bin/mpivars.sh
...
#  io500_mpiargs="-ppn 38 -n 1520 -hostfile hostfile"
#  io500_mpiargs="-ppn 2 -n 80 -hostfile hostfile"
}
