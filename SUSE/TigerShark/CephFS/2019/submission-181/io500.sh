...
function extra_description {
  ...
  io500_info_data_storage_type='Intel® SSD D3-S4510' # HDD, SSD, persistent memory, etc, feel free to put specific models
  io500_info_metadata_storage_type='Intel® Optane SSD DC P4800X' # HDD, SSD, persistent memory, etc, feel free to put specific models
