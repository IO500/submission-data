...
io500_mpirun="mpirun"
io500_mpiargs="--prefix /usr/mpi/gcc/openmpi-4.1.7a1 --allow-run-as-root --oversubscribe --mca pml ucx -x UCX_NET_DEVICES=mlx5_0:1 --mca plm_rsh_no_tree_spawn 1 --map-by ppr:8:socket -np 3840 -N 16 -hostfile /lustre/ddn/bin/hostfile"
...
function setup(){
  ...
  mkdir $workdir/mdtest-easy $workdir/mdtest-hard
  #lfs setstripe -c -1 $workdir/ior-hard
  #lfs setstripe -C 32 $workdir/ior-hard
