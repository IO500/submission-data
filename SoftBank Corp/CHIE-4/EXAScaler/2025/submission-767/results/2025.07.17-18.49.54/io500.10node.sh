...
io500_mpirun="mpirun"
io500_mpiargs="--prefix /usr/mpi/gcc/openmpi-4.1.7rc1 --allow-run-as-root --oversubscribe --mca coll ^hcoll --map-by ppr:64:socket --mca pml ucx -x UCX_NET_DEVICES=mlx5_11:1 --mca plm_rsh_no_tree_spawn 1 -np 1280 -N 128 -hostfile /lustre/bin/hostlist.10node /lustre/ddn/bin/singularity.sh /lustre -B /usr -B /sys/class/infiniband_verbs -B /bin -B /sbin -B /etc/libibverbs.d -B /tmp /lustre/ddn/bin/ubuntu24.04.sif " 
