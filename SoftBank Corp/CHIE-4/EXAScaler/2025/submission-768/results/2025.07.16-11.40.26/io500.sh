...
io500_mpirun="mpirun"
io500_mpiargs="--prefix /usr/mpi/gcc/openmpi-4.1.7rc1 --allow-run-as-root --oversubscribe --mca pml ucx -x UCX_NET_DEVICES=mlx5_11:1 --mca plm_rsh_no_tree_spawn 1 -np 4000 -N 8 -hostfile /lustre/bin/hostlist"
