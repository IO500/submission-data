...
function setup_directories {
  ...
  io500_workdir=/mnt/beegfs/datafiles/io500.$timestamp # directory where the data will be stored
...
#  beegfs-ctl --createdir --nodes=666 ${io500_workdir}/mdt_hard

  # for ior_easy.
  beegfs-ctl --setpattern --numtargets=1 --chunksize=1024k ${io500_workdir}/ior_easy
  beegfs-ctl --setpattern --numtargets=192 --chunksize=256k ${io500_workdir}/ior_hard
#  beegfs-ctl --setpattern --storagepoolid=2 --chunksize=64K --numtargets=22 ${io500_workdir}/ior_hard
# turn off striping and use small chunks for mdtest
  beegfs-ctl --setpattern --numtargets=1 --chunksize=64k ${io500_workdir}/mdt_easy
  beegfs-ctl --setpattern --numtargets=2 --chunksize=64k ${io500_workdir}/mdt_hard
...
function setup_find {
  ...
  io500_find_cmd_args="-N -q 2000 -s 300  -r $io500_result_dir/pfind_results"
