...
io500_mpirun="mpirun"
io500_mpiargs="-np 312 -hosts Client-2,Client-3,Client-4,Client-5,Client-6,Client-7"
...
function setup(){
  ...
  lfs setstripe -C $((osts * 6)) $workdir/ior-hard # ||
  ...
  lfs setstripe -E 1M -L mdt $workdir/mdtest-rnd
}
