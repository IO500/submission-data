...
function setup_paths {
  ...
  io500_mpiargs="-f hostfile48 -n 336"
  export LD_LIBRARY_PATH=$PWD/lib
  export QUOBYTE_STRIP_PATH=/var/tmp
  export ROMIO_FSTYPE_FORCE="quobyte:"
  QUOBYTE_CLIENT_OPTIONS="--no-metric-pushes --enable-unaligned-direct-io=true --log-file-path=/var/tmp/libquobyte_336.log -d INFO --periodic_volume_tasks_interval_s=480"
