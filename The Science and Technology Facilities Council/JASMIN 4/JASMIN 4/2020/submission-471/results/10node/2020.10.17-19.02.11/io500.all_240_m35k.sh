...
function setup_paths {
  ...
  io500_mpirun="$PWD/bin/mpiexec"
  io500_mpiargs="-f hostfile10 -n 240"
  export LD_LIBRARY_PATH=$PWD/lib
  export QUOBYTE_STRIP_PATH=/var/tmp
  export ROMIO_FSTYPE_FORCE="quobyte:"
  QUOBYTE_CLIENT_OPTIONS="--no-metric-pushes --enable-unaligned-direct-io=true --log-file-path=/var/tmp/libquobyte_240.log -d INFO --periodic_volume_tasks_interval_s=480"
  QUOBYTE_CLIENT_OPTIONS="$QUOBYTE_CLIENT_OPTIONS --registry=sds.jc.rl.ac.uk"
