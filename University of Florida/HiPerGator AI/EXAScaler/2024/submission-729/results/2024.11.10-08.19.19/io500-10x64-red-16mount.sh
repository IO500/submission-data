...
#io500_mpiargs="-np 2"
io500_mpiargs="--map-by ppr:8:numa:pe=1 --bind-to core -np 640 --hostfile /home/cpp/local/src/io500/hostfile.10x64 -x UCX_POSIX_USE_PROC_LINK=n -x APPTAINERENV_LD_LIBRARY_PATH=$LD_LIBRARY_PATH -x UCX_NET_DEVICES=mlx5_0:1,mlx5_1:1,mlx5_2:1,mlx5_3:1,mlx5_6:1,mlx5_7:1,mlx5_8:1,mlx5_9:1 -mca pml ucx -mca btl ^openib /home/cpp/local/src/io500/apptainer16.sh /red -B /apps -B /opt -B /usr -B /bin -B /sbin -B /sys/class/infiniband_verbs /home/cpp/local/src/io500/rockylinux_9.sif"
