...
#io500_mpiargs="-np 2"
#io500_mpiargs="--use-hwthread-cpus --map-by hwt --bind-to hwt -np 1920 --hostfile /home/cpp/local/src/io500/hostfile.10x192_turin -x UCX_POSIX_USE_PROC_LINK=n -x APPTAINERENV_LD_LIBRARY_PATH=$LD_LIBRARY_PATH -x UCX_NET_DEVICES=mlx5_0:1 -mca pml ucx -mca btl ^openib -mca coll_hcoll_enable 0 /home/cpp/local/src/io500/apptainer.sh 24 /blue2 -B /apps -B /opt -B /usr -B /bin -B /sbin -B /sys/class/infiniband_verbs /home/cpp/local/src/io500/rockylinux_9.sif "
io500_mpiargs="--use-hwthread-cpus --map-by node --bind-to none -np 1920 --hostfile /home/cpp/local/src/io500/hostfile.10x192_turin -x UCX_POSIX_USE_PROC_LINK=n -x APPTAINERENV_LD_LIBRARY_PATH=$LD_LIBRARY_PATH -x UCX_NET_DEVICES=mlx5_0:1 -mca pml ucx -mca btl ^openib -mca coll_hcoll_enable 0 /home/cpp/local/src/io500/apptainer-stripe-over-nodes-numanodes-stripe-mounts-over-ranks.sh 4 24 24 /blue2 -B /apps -B /opt -B /usr -B /bin -B /sbin -B /sys/class/infiniband_verbs /home/cpp/local/src/io500/rockylinux_9.sif "
...
function setup(){
  ...
  # DNE3 for mdtest-easy
  lfs setdirstripe -D -c 1 -i -1 -X -1 --max-inherit-rr 3 $workdir/mdtest-easy
