...
function setup_ior_easy {
  ...
  io500_ior_easy_params="-a POSIX -B -t 1024k -b ${io500_ior_easy_size}m -F"
}
...
function setup_ior_hard {
  ...
  io500_ior_hard_other_options="-B -a POSIX" #e.g., -E to keep precreated files using lfs setstripe, or -a MPIIO
}
...
function extra_description {
  ...
  io500_info_institute_name='WekaIO'   # e.g. JCAHPC
  ...
  io500_info_filesystem='WekaIO Matrix'     # e.g. BeeGFS, DataWarp, GPFS, IME, Lustre
  ...
  io500_info_num_metadata_storage_devices='192'  # if you have 2 metadata servers, and each has 5 drives, then this number is 10
