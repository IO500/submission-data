...
function setup_directories {
  ...
  io500_result_dir=/mnt/yrfs/results/$timestamp      # the directory where the output results will be kept
...
function setup_paths {
  ...
  io500_mpirun="mpirun"
  # io500_mpiargs="--allow-run-as-root --oversubscribe --mca btl openib,self,vader --mca btl_openib_cpc_include rdmacm --mca btl_openib_ipaddr_include '10.10.200.0/24' --hostfile ./hostfile --map-by node --np 96"
...
function setup_mdt_easy {
  io500_mdtest_easy_params="-u -L -z 2 -b 16" # unique dir per thread, files only at leaves
